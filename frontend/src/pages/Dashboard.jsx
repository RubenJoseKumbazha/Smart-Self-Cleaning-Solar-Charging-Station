  ...
  return (
    <div className="space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          <h1 className="text-3xl font-semibold tracking-tight">Solar Bench Overview</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Live polling every 5 minutes with latest bench health metrics.</p>
        </div>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-soft dark:border-slate-700 dark:bg-slate-900">
        <div className="mb-5 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Monitor bench status and access device controls.</p>
          </div>
          <Link
            to="/analytics"
